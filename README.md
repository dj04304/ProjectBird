...
팀장으로서 부족한 부분도 많았고, 갈피를 못 잡을 때 마다 다들 잘 참여해주셔서 덕분에 프로젝트가 성공적으로 마무리되었다고 생각합니다.  
다른 분들의 코드를 보면서 공부도 많이 됐고, 풀이 방식과 새로운 내용도 많이 알게 되어 정말 좋은 경헙이라고 생각합니다.  
따뜻하게 대해주셔서 너무 편했고 제 실력이 부족했지만 많은 도움을 받은 것 같아 좋았습니다. 
앞으로도 더 공부해야겠다는 마음이 계속 들게 해주셔서 감사합니다!
...
두번째 팀별 활동에서 본격적으로 유니티를 통한 팀별 활동을 진행하였습니다.
팀원들 모두 각자 뛰어난 경험을 바탕으로 팀 과제 제작에 모두 빛을 발휘해주셨습니다.
비록 팀 활동에 경험이 부족해서 팀원들한테 지장이 될까봐 걱정했지만,
저번 팀 활동을 통해 배운 깃허브를 통한 협업 경험이 팀의 기능 구현을 바탕으로
프로젝트를 통합하는 머지에 도움이 된 점에서 다행이라고 생각합니다.

1주일 동안 달린 팀원 분들께 진심으로 감사하다고 생각합니다.
